...
class Trainer:
    ...
    def load_data(self, batch_size=None, num_points=None):
        ...
        self.train_dataset, self.validation_dataset, _ = torch.utils.data.random_split(self.dataset, [n_train, n_val, ignore])
...
if __name__ == '__main__':
    ...
    if o:
        ...
        study = optuna.load_study(study_name="dgcnn1", storage="postgresql://15fiedler:uMLtzMNz5EFzyMlQ5Y4EYV0y@rzrobo3/optuna_studies")
