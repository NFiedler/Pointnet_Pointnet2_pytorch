...
class Trainer:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--emb_dims', type=int, default=1024, help='embedded dimensions')
        parser.add_argument('--k', type=int, default=20, help='k for dgcnn nearest neighbors')
